                    ...
                    <div className="hidden sm:block sm:ml-6">
                        <div className="flex space-x-9">
                            ...
                            <div className="mr-30      flex space-x-4">
                                ...
                                <a href="#" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Student Signup</a>
                                <a href="#" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Employer Signup</a>
                            </div>                
                                </div>
                    </div>
                </div>
